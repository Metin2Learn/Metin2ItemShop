...
# 1) Buscar: class EditLine(TextLine):
#Dentro de class EditLine(TextLine):
"""
...
#OJO! Hay 2		
#Seguimos en class EditLine(TextLine)
# 1) Buscar:
"""
...
"""
# debajo de ese def
# 2) Hacer una nueva línea y pegar esto:
...
# Debajo debe tener esto: self.SetFocus()
...
# 1) Para abrir la ventana de la itemshop usar esta función:
